  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.highlightRange = function(normedRange, cssClass) {
      ...
      if (cssClass == null) {
        ...
        //cssClass = 'annotator-hl merde';//POSSIBLE AJOUTER une classe pour la couleur !
      white = /^\s*$/;
...
//NPS
    ...
    Annotator.prototype.onSelectClick = function(annotation) {
        //var annotations;
        //function simpleKeys (original) {
            ...
            //}, {});
        //}
        ////alert(JSON.stringify(simpleKeys(event)));
        //annotations = $(event.target).parents('.annotator-hl').addBack().map(function() {
            //return $(this).data("annotation");
        //}).toArray();
        annotation.text = annotation.text + " CLICKED";
        //var test = $(event.target).parents('.annotator-hl');
       //// $(event.target).parents(".annotator-hl").addBack().addClass("clicked");
        //id ="clicked";
    //annotations[0].id="clicked";
       //// annotations.forEach(function(an){an.id="test";})
    //$(".annotator-hl").map(function(){
            //if($(this).data("annotation").id===id){
            //$(this).addBack().addClass("clicked");
            //}
        //}).addClass("clicked");
    ...
    Annotator.prototype.onHighlightClick = function(event) {
        ...
        annotations[0].text = annotations[0].text + " CLICKED";
        var test = $(event.target).parents('.annotator-hl');
       // $(event.target).parents(".annotator-hl").addBack().addClass("clicked");
        id ="clicked";
    annotations[0].id="clicked";
...
//NPS
Annotator.prototype.restoreAnnotation = function(annotation) {
      var annotation, cancel, cleanup, position, save,
        _this = this;
    ...
    Annotator.prototype.onEditAnnotation = function(annotation) {
      //NPS
        console.log("Selected %s", iframeId+annotation.zone);
            $('#'+iframeId+annotation.zone, window.parent.document).prop('checked', true);;
        parent.angular.element('#'+iframeId+annotation.zone).scope().stateChanged('#'+iframeId+annotation.zone);
      //this.viewer.hide();
      id = "clicked"
   annotation.id="clicked";
       // annotations.forEach(function(an){an.id="test";})
    $(".annotator-hl").map(function(){
            if($(this).data("annotation").id===id){
            $(this).addBack().removeClass("clicked");
            }
        }).addClass("clicked");
    ...
    Annotator.prototype.onDeleteAnnotation = function(annotation) {
      //this.viewer.hide();
        console.log("Deselected %s", iframeId+annotation.zone);
            $('#'+iframeId+annotation.zone, window.parent.document).prop('checked', false);;
        parent.angular.element('#'+iframeId+annotation.zone).scope().stateChanged('#'+iframeId+annotation.zone);
